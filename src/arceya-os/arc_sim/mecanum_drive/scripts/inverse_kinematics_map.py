...
def main():
    ...
    pub = rospy.Publisher('/mecanum_drive/cmd_vel', Twist, queue_size = 1)
    ...
    rospy.Subscriber('/mecanum_drive/odom', Odometry, callback=odometryCb)
...
#     pub_cmd = rospy.Publisher('/mecanum_drive/cmd_vel', Twist, queue_size=1)
#     rospy.Subscriber('/mecanum_drive/odom', Odometry, callback=odometryCb)
